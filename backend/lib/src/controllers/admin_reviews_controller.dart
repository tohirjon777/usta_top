...
''';
  ...
  static const Map<String, Map<String, String>> _strings =
    ...
    'uz': <String, String>{
      ...
      'heroDescription':
          'Javobsiz sharhlar tepada ko‘rinadi. Admin shu yerdan muammoni tez aniqlab, ustaxona yoki owner inboxga o‘tadi.',
      'statAll': 'Jami sharh',
      ...
      'statAnsweredSub': 'Ustaxona yoki Telegramdan javob yozilgan sharhlar.',
      'statHidden': 'Yashirilgan',
      'statHiddenSub': 'Moderatsiya orqali ko‘rinishdan olingan sharhlar.',
      'filterEyebrow': 'Qidiruv va Filtr',
      'searchLabel': 'Ustaxona, xizmat, mijoz, telefon yoki sharh bo‘yicha qidiruv',
      ...
      'pendingReplyBody':
          'Ustaxona egasi hali sharhga javob bermagan. Owner inbox yoki Telegram orqali javob berishi mumkin.',
      ...
      'workshopLink': 'Ustaxona kartasi',
      'bookingsLink': 'Ustaxona zakazlari',
    ...
    'ru': <String, String>{
      ...
      'heroDescription':
          'Отзывы без ответа показываются сверху. Админ быстро видит проблему и может перейти в автосервис или owner inbox.',
      ...
      'statAnsweredSub': 'Отзывы, где ответ уже дан из автосервиса или Telegram.',
      'statHidden': 'Скрытые',
      'statHiddenSub': 'Отзывы, скрытые модерацией.',
      'filterEyebrow': 'Поиск и фильтр',
      'searchLabel': 'Поиск по автосервису, услуге, клиенту, телефону или отзыву',
      ...
      'workshopNotFound': 'Автосервис не найден',
      'hiddenReviewReminderBlocked':
      ...
      'workshopLink': 'Карточка автосервиса',
      'bookingsLink': 'Заказы автосервиса',
      'ownerLink': 'Owner login',
